...
def low_noise_rotor_design(rotor,
    ...
    output = scipy_setup.SciPy_Solve(optimization_problem,solver=solver_name, sense_step = 1E-3, tolerance = 1E-2)  
    print (output) 
...
def low_noise_rotor_optimization_setup(rotor): 
    ...
    aliases.append([ 'c0_min_c1'                 , 'summary.c0_min_c1'       ]) # monotonic decreasing chord (not necessarily true)
    aliases.append([ 'c1_min_c2'                 , 'summary.c1_min_c2'       ]) # monotonic decreasing chord (not necessarily true)  
    aliases.append([ 'c2_min_c3'                 , 'summary.c2_min_c3'       ]) # monotonic decreasing chord (not necessarily true) 
    if rotor.blade_optimization_pivots == 5:
        aliases.append([ 'c3_min_c4'                 , 'summary.c3_min_c4'       ])  # monotonic decreasing chord (not necessarily true)
    aliases.append([ 't0_min_t1'                 , 'summary.t0_min_t1'       ])   # monotonic decreasing twist
    aliases.append([ 't1_min_t2'                 , 'summary.t1_min_t2'       ])   # monotonic decreasing twist
    aliases.append([ 't2_min_t3'                 , 'summary.t2_min_t3'       ])   # monotonic decreasing twist
    if rotor.blade_optimization_pivots == 5:
        aliases.append([ 't3_min_t4'                 , 'summary.t3_min_t4'       ])  # monotonic decreasing twist  
...
def set_optimized_rotor_planform(rotor,optimization_problem):
    ...
    rotor_opt                = optimization_problem.vehicle_configurations.rotor_testbench.networks.battery_propeller.lift_rotors.rotor
