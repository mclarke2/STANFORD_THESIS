...
def design_BO_105_prop():          
    ...
    prop.airfoil_geometry           = ['Propellers_Rotors/NACA_23012.txt']
    prop.airfoil_polars             = [['Propellers_Rotors/NACA_23012_polar_Re_50000.txt',
                                        'Propellers_Rotors/NACA_23012_polar_Re_100000.txt',
                                        'Propellers_Rotors/NACA_23012_polar_Re_200000.txt',
                                        'Propellers_Rotors/NACA_23012_polar_Re_500000.txt',
                                        'Propellers_Rotors/NACA_23012_polar_Re_1000000.txt']] 
