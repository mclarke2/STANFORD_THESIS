...
def main():
    ...
    objective_weights = np.linspace(0.0,1.0,21) 
    #use_pyoptsparse   = False 
    #single_design_point(objective_weights,use_pyoptsparse)
    plot_rotor_designs_and_pareto_fronteir(objective_weights,plot_parameters)
...
# ------------------------------------------------------------------ 
def single_design_point(objective_weights,use_pyoptsparse_flag): 
...
# ------------------------------------------------------------------ 
def plot_rotor_designs_and_pareto_fronteir(objective_weights,PP):    
