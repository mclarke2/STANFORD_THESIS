...
from Stopped_Rotor  import   missions_setup ,full_mission_setup,approach_departure_mission_setup,full_mission_setup
...
def setup(analyses, vehicle):
    ...
    missions.mission = full_mission_setup(analyses,vehicle,simulated_days,flights_per_day,
