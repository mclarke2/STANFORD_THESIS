...
def main(): 
    ...
    if plot_SR_results:
        ...
        sr_hover_filename          = header + 'Stopped_Rotor_Hover_Mission' + '_Nx' + str(N_gm_x) + '_Ny' + str(N_gm_y)
    ...
    if plot_TW_results:
        ...
        tw_hover_filename          = header + 'Tiltwing_Hover_Mission' + '_Nx' + str(N_gm_x) + '_Ny' + str(N_gm_y)
    ...
    if plot_MR_results:
        ...
        mr_hover_filename          = header + 'Multirotor_Hover_Mission' + '_Nx' + str(N_gm_x) + '_Ny' + str(N_gm_y)
