...
def design_F8745D4_prop():  
    ...
    prop.airfoil_polars             = [['../Airfoils/Polars/Clark_y_polar_Re_50000.txt' ,'../Airfoils/Polars/Clark_y_polar_Re_100000.txt','../Airfoils/Polars/Clark_y_polar_Re_200000.txt',
