...
def vehicle_setup():
    ...
    net.rotor_nacelle_diameter      = 0.5
    net.rotor_engine_length         = 1.5
    net.propeller_nacelle_diameter  = 0.5
    net.propeller_engine_length     = 2.0  
    net.propeller_nacelle_end       = 1.0
    net.propeller_nacelle_start     = 0.2  
    net.rotor_nacelle_end           = 1.0
    net.rotor_nacelle_start         = 0.0
    net.propeller_nacelle_offset    = [0.5,0.0,-0.35]
    net.rotor_nacelle_offset        = [0.25,0.0,0.0]
    net.areas                       = Data()
    ...
    prop_rotor.design_thrust              = (Hover_Load)/net.number_of_engines  
    prop_rotor.symmetric                  = True  
    prop_rotor.rotation                   = [1,1]
    prop_rotor.origin                     = [[-0.109,2.283 ,1.630],[-0.109,-2.283 ,1.630]]
    ...
    rotor.origin                          = [[ 2.283,4.891,2.391],[ 2.283,-4.891,2.391],[6.522,2.174,2.065],[6.522,-2.174,2.065]]
