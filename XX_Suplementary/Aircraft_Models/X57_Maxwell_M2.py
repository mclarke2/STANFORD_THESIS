...
def vehicle_setup():
    ...
    segment.sweeps.quarter_chord          = 53. * Units.degrees 
    segment.thickness_to_chord            = 0.12 
    segment.append_airfoil(airfoil)
    wing.append_segment(segment)
    ...
    # ------------------------------------------------------------------
    # plot vehicle 
    #plot_vehicle(vehicle, elevation_angle = 30,azimuthal_angle = 210, axis_limits =5,plot_control_points = False)
    #plt.show()
...
def configs_setup(vehicle):
    ...
    config.networks.battery_propeller.motor.gear_ratio   = 1.1
